<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageAboutUs.aspx.cs" Inherits="YourJester.ScreenAboutUs.PageOurCompany" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, PageAboutUsTitle%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <p style="color: #FFFFFF; text-align: justify">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, PageAboutUsLongText%>" />
                    </p>
                    <p>
