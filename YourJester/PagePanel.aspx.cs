...
/// Goal:           Treat PANNEL page that contains the actionButtons that allow the access to each STEP
///                 to be maintained by users with questions and answers in order to increase the 
///                 user yourself knowlegment and discover the current life situation and make plans
///                 to the future and monitoring the tasks progress
/// *********************************************************************************************************************
...
{
    public partial class PagePanel : System.Web.UI.Page
    {
        ...
        ///                 
        ///                 The user just have access to portal page in case that LogOn procedure has been done
        ///                 The actionButtons will be available to users that needs to answer the question or make the plans
        /// *********************************************************************************************************************
        /// Maintenance:    yyyy/mm/dd
        /// Author:	    	Rosemeire Deconti
        /// Goal:           inform the description of maintenance
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            R8000DatabaseCheckUserProgress(userCode, "01", "01");
            ...
            R8000DatabaseCheckUserProgress(userCode, "02", "01");
            ...
            R8000DatabaseCheckUserProgress(userCode, "03", "13");
            ...
            R8000DatabaseCheckUserProgress(userCode, "04", "01");
            ...
            R8000DatabaseCheckUserProgress(userCode, "04", "02");
            ...
            R8000DatabaseCheckUserProgress(userCode, "04", "03");
            ...
            R8000DatabaseCheckUserProgress(userCode, "05", "01");
            ...
            R8000DatabaseCheckUserProgress(userCode, "06", "01");
            ...
            R8000DatabaseCheckUserProgress(userCode, "07", "01");
            ...
            R8000DatabaseCheckUserProgress(userCode, "08", "01");
