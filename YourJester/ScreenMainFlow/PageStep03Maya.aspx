<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStep03Maya.aspx.cs" Inherits="YourJester.PageStep03Maya" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textAstrologyMaya%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
