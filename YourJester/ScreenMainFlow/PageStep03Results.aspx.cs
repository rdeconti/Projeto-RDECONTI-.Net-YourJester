...
/// Goal:           Treat Step03: The answers from user are analysed and the characteristics classified and counted in 3
...
{
    public partial class PageStep03Results : System.Web.UI.Page
    {
        ...
        protected void R0150DatabaseGetPositiveCharacteristics()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT * FROM users_Step03_characteristics WHERE userCode = @userCode and type=@type";
                databaseCommand.Parameters.AddWithValue("@userCode", userCode);
        ...
        protected void R0200SetChartProprieties()
        {
            ...
            {
                case 0:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep03Positive").ToString();
                    txtFinalAnalysis.Text = finalAnalysis + txtFinalAnalysis.Text;
                    break;
                case 1:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep03Negative").ToString();
                    txtFinalAnalysis.Text = finalAnalysis + txtFinalAnalysis.Text;
                    break;
                case 2:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep03Neutral").ToString();
                    txtFinalAnalysis.Text = finalAnalysis + txtFinalAnalysis.Text;
                    break;
                case 3:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep03Incomplete").ToString();
