<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStep03Aztec.aspx.cs" Inherits="YourJester.PageStep03Aztec" %>
    ...
    <section id="services" style="background-image: url('../Images/backgrounds/bg_09.jpg');">
       <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textAstrologyAztec%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
            ...
            <div class="form-group center">
                <asp:button ID="buttonQuestions" runat="server" Text="<%$ Resources:Resources,textYouByOthers%>" PostBackUrl="~/ScreenMainFlow/PageStep03Questions.aspx" CssClass="btn btn-primary btn-sm"/>
                <asp:button ID="buttonHome" runat="server" Text="<%$ Resources:Resources, textHome %>" PostBackUrl="~/PageHome.aspx" CssClass="btn btn-primary btn-sm" />
            </div>
        </div>
    </section>
</asp:Content>
