...
/// Goal:           Treat Step02: The answers from user are analysed and the characteristics classified and counted in 3
...
{
    public partial class PageStep02Results : System.Web.UI.Page
    {
        ...
        public string fieldValue001 = "1";
        public string fieldValue002 = "2";
        public string fieldValue003 = "3";
        ...
        protected void R0150DatabaseGetPositiveCharacteristics()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT * FROM users_step02_answers WHERE userCode = @userCode and answer=@answer";
                databaseCommand.Parameters.AddWithValue("@userCode", userCode);
                databaseCommand.Parameters.AddWithValue("@answer", keyType);
                databaseCommand.Connection = databaseConnection;
                ...
                {
                    keyCode = databaseContainer.GetString("question_code").ToString();
                    R0180DatabaseGetCharacteristicText();
                    R0190DatabaseUpdateUsersStep02Characteristics();
                }
            }
        ...
        protected void R0190DatabaseUpdateUsersStep02Characteristics()
        {
            MySqlCommand databaseCommand = new MySqlCommand();
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT * FROM users_Step02_characteristics WHERE userCode=@userCode and type=@type and characteristic=@characteristic";
                databaseCommand.Parameters.AddWithValue("@userCode", userCode);
                ...
                if (!databaseContainer.Read())
                {
                    ...
                    databaseCommand.CommandText = "INSERT INTO users_Step02_characteristics (userCode, type, characteristic) VALUES (@userCode, @type, @characteristic)";
                    databaseCommand.Parameters.AddWithValue("@userCode", userCode);
                    databaseCommand.Parameters.AddWithValue("@type", keyType);
                    databaseCommand.Parameters.AddWithValue("@characteristic", keyCode);
                    databaseCommand.Connection = databaseConnection;
        ...
        protected void R0200SetChartProprieties()
        {
            ...
            {
                case 0:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep02Positive").ToString();
                    txtFinalAnalysis.Text = finalAnalysis + txtFinalAnalysis.Text;
                    break;
                case 1:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep02Negative").ToString();
                    txtFinalAnalysis.Text = finalAnalysis + txtFinalAnalysis.Text;
                    break;
                case 2:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep02Neutral").ToString();
                    txtFinalAnalysis.Text = finalAnalysis + txtFinalAnalysis.Text;
                    break;
                case 3:
                    finalAnalysis = HttpContext.GetGlobalResourceObject("Resources", "longtextFinalAnalysisStep02Incomplete").ToString();
