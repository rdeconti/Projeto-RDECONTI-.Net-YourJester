<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStep03Brazilian.aspx.cs" Inherits="YourJester.PageStep03Brazilian" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textAstrologyBrazilian%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
