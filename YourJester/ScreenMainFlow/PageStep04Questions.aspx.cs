...
/// Goal:           Treat Step04: Several characteristics (values, temperaments, personality, fears, emotions ...) are
///                 explained to user, based on several kind of tests (enneagram, hippocrates and CPS). The user need 
///                 to answer if the characteristic is applicable or not to your life
/// *********************************************************************************************************************
...
{
    public partial class PageStep04Questions : System.Web.UI.Page
    {
