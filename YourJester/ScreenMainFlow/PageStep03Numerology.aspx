<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStep03Numerology.aspx.cs" Inherits="YourJester.PageStep03Numerology" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textNumerology%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
