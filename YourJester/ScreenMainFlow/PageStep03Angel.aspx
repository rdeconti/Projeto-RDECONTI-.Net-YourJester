<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStep03Angel.aspx.cs" Inherits="YourJester.PageStep03Angel" %>
    ...
    <section id="services" style="background-image: url('../Images/backgrounds/bg_09.jpg');">
       <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textAngels%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
            ...
            <div class="form-group center">
                <asp:button ID="buttonReturn" runat="server" Text="<%$ Resources:Resources,textYouByOthers%>" PostBackUrl="~/ScreenMainFlow/PageStep03Questions.aspx" CssClass="btn btn-primary btn-sm"/>
