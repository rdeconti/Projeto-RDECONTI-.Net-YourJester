...
/// Goal:           Based on user birthdate the portal shows to user data from pressage of birthday
/// *********************************************************************************************************************
...
{
    public partial class PageStep03DayOfBorn : System.Web.UI.Page
    {
        ...
        {
            imageCodeImage.ImageUrl = "../Images/dayofborn/" + userBirthday + ".jpg";
        }
        ...
        protected void R0140DatabaseGetDescription()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT PRESSAGE FROM step03_dayofborn_description WHERE day=@day and month=@month and language=@language";
                ...
                {
                    txtDescription.Text = databaseContainer.GetString("pressage");
                }
            }
        ...
        protected void R0150DatabaseGetPositiveCharacteristics()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT CHARACTERISTIC FROM step03_dayofborn_characteristics WHERE day=@day and month=@month";
                databaseCommand.Parameters.AddWithValue("@day", userBirthday);
                databaseCommand.Parameters.AddWithValue("@month", userBirthMonth);
        ...
        protected void R0175DatabaseSetUserProgressCompletion()
        {
            ...
            try
            {
                ...
                if (databaseContainer.Read())
                {
                    if ((databaseContainer.GetString("phase12") == "N"))
                    {
                        ...
                        databaseCommand01.CommandText = "UPDATE users_step03_results SET test_start=@test_start, positive=@positive, negative=@negative, neutral=@neutral, questions=@questions, phase12=@phase12 WHERE userCode=@userCode";
                        ...
                        databaseCommand01.Parameters.AddWithValue("@phase12", "Y");
                ...
                else
                {
                    ...
                    databaseCommand02.CommandText = "INSERT INTO users_step03_results (userCode, test_start, test_finish, positive, negative, neutral, questions, phase12) VALUES (@userCode, @test_start, @test_finish, @positive, @negative, @neutral, @questions, @phase12)";
                    ...
                    databaseCommand02.Parameters.AddWithValue("@phase12", "Y");
        ...
        protected void R0310DatabaseUpdateUserProgress()
        {
            ...
            try
            {
                ...
                databaseCommand.Parameters.AddWithValue("@phase_level_2", "12");
                databaseCommand.Connection = databaseConnection;
                ...
                if (databaseContainer.Read())
                {
                    ...
                    databaseCommand01.Parameters.AddWithValue("@phase_level_2", "12");
