...
/// Goal:           Based on user birthdate th portal shows to user data from your Angel
/// *********************************************************************************************************************
...
{
    public partial class PageStep03Angel : System.Web.UI.Page
    {
        ...
        protected void R0110DatabaseGetCode()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT ANGEL FROM step03_angel_calendar WHERE day = @day and month = @month";
                databaseCommand.Parameters.AddWithValue("@day", userBirthday);
                databaseCommand.Parameters.AddWithValue("@month", userBirthMonth);
                databaseCommand.Parameters.AddWithValue("@year", userBirthYear);
                ...
                {
                    keyCode = databaseContainer.GetString("angel");
                }
            }
        ...
        {
            imageCodeImage.ImageUrl = "../Images/angel/" + keyCode + ".jpg";
        }
        ...
        protected void R0130DatabaseGetName()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT NAME FROM step03_angel_names WHERE code=@code and language=@language";
        ...
        protected void R0140DatabaseGetDescription()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT POSITIVE, NEGATIVE FROM step03_angel_description WHERE code=@code and language=@language";
                databaseCommand.Parameters.AddWithValue("@code", keyCode);
                databaseCommand.Parameters.AddWithValue("@language", userLanguage);
                databaseCommand.Connection = databaseConnection;
                ...
                if (databaseContainer.Read())
                {
                    txtDescription.Text = databaseContainer.GetString("positive") + databaseContainer.GetString("negative");
                }
            }
        ...
        protected void R0150DatabaseGetPositiveCharacteristics()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT CHARACTERISTIC FROM step03_angel_characteristics WHERE code=@code and type=@type";
                databaseCommand.Parameters.AddWithValue("@code", keyCode);
        ...
        protected void R0175DatabaseSetUserProgressCompletion()
        {
            ...
            try
            {
                ...
                if (databaseContainer.Read())
                {
                    if ((databaseContainer.GetString("phase11") == "N"))
                    {
                        ...
                        databaseCommand01.CommandText = "UPDATE users_step03_results SET test_start=@test_start, positive=@positive, negative=@negative, neutral=@neutral, questions=@questions, phase11=@phase11 WHERE userCode=@userCode";
                        ...
                        databaseCommand01.Parameters.AddWithValue("@phase11", "Y");
                ...
                else
                {
                    ...
                    databaseCommand02.CommandText = "INSERT INTO users_step03_results (userCode, test_start, test_finish, positive, negative, neutral, questions, phase11) VALUES (@userCode, @test_start, @test_finish, @positive, @negative, @neutral, @questions, @phase11)";
                    ...
                    databaseCommand02.Parameters.AddWithValue("@phase11", "Y");
        ...
        protected void R0310DatabaseUpdateUserProgress()
        {
            ...
            try
            {
                ...
                databaseCommand.Parameters.AddWithValue("@phase_level_2", "11");
                databaseCommand.Connection = databaseConnection;
                ...
                if (databaseContainer.Read())
                {
                    ...
                    databaseCommand01.Parameters.AddWithValue("@phase_level_2", "11");
