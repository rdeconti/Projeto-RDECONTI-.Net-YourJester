...
/// Goal:           Based on user birthdate the portal shows to user data from Maya oracle
/// *********************************************************************************************************************
...
{
    public partial class PageStep03Maya : System.Web.UI.Page
    {
        ...
        protected void R0110DatabaseGetCode()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT SIGN FROM step03_astrology_maya_calendar WHERE month_FROM <= @month and month_to >= @month";
        ...
        {
            imageCodeImage.ImageUrl = "../Images/maya/" + keyCode + ".jpg";
        }
        ...
        protected void R0130DatabaseGetName()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT NAME FROM step03_astrology_maya_names WHERE code=@code and language=@language";
        ...
        protected void R0140DatabaseGetDescription()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT DESCRIPTION FROM step03_astrology_maya_description WHERE sign=@code and language=@language";
                databaseCommand.Parameters.AddWithValue("@code", keyCode);
                databaseCommand.Parameters.AddWithValue("@language", userLanguage);
                databaseCommand.Connection = databaseConnection;
        ...
        protected void R0150DatabaseGetPositiveCharacteristics()
        {
            ...
            try
            {
                ...
                databaseCommand.CommandText = "SELECT CHARACTERISTIC FROM step03_astrology_maya_characteristics WHERE code=@code and type=@type";
                databaseCommand.Parameters.AddWithValue("@code", keyCode);
        ...
        protected void R0175DatabaseSetUserProgressCompletion()
        {
            ...
            try
            {
                ...
                if (databaseContainer.Read())
                {
                    if ((databaseContainer.GetString("phase08") == "N"))
                    {
                        ...
                        databaseCommand01.CommandText = "UPDATE users_step03_results SET test_start=@test_start, positive=@positive, negative=@negative, neutral=@neutral, questions=@questions, phase08=@phase08 WHERE userCode=@userCode";
                        ...
                        databaseCommand01.Parameters.AddWithValue("@phase08", "Y");
                ...
                else
                {
                    ...
                    databaseCommand02.CommandText = "INSERT INTO users_step03_results (userCode, test_start, test_finish, positive, negative, neutral, questions, phase08) VALUES (@userCode, @test_start, @test_finish, @positive, @negative, @neutral, @questions, @phase08)";
                    ...
                    databaseCommand02.Parameters.AddWithValue("@phase08", "Y");
        ...
        protected void R0310DatabaseUpdateUserProgress()
        {
            ...
            try
            {
                ...
                databaseCommand.Parameters.AddWithValue("@phase_level_2", "08");
                databaseCommand.Connection = databaseConnection;
                ...
                if (databaseContainer.Read())
                {
                    ...
                    databaseCommand01.Parameters.AddWithValue("@phase_level_2", "08");
