<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStep07Results.aspx.cs" Inherits="YourJester.ScreenMainFlow.PageStep07Results" %>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="media services-wrap">
                        ...
                        <div class="media-body">
                            <h4 style="text-align: left; font-weight: bold;">
                                <asp:Literal runat="server" Text="<%$ Resources:Resources, textCharacteristicsNeutral%>" />
                                <asp:Literal runat="server" Text="(" />
                                <asp:Literal runat="server" ID="txtNeutralNumber" />
                                <asp:Literal runat="server" Text=")" />
                            </h4>
                            <p style="text-align: left">
                                <asp:Literal runat="server" ID="txtNeutralCharacteristics" />
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="media services-wrap">
                        ...
                        <div class="media-body">
                            <h4 style="text-align: left; font-weight: bold;">
                                ...
                                <asp:Literal runat="server" Text="(" />
                                <asp:Literal runat="server" ID="txtPositiveNumber" />
                                <asp:Literal runat="server" Text=")" />
                            </h4>
                            <p style="text-align: left">
                    ...
                    <div class="media services-wrap">
                        ...
                        <div class="media-body">
                            <h4 style="text-align: left; font-weight: bold;">
                                ...
                                <asp:Literal runat="server" Text="(" />
                                <asp:Literal runat="server" ID="txtNegativeNumber" />
                                <asp:Literal runat="server" Text=")" />
                            </h4>
                            <p style="text-align: left">
