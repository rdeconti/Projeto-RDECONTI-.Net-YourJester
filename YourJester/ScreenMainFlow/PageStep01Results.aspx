<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStep01Results.aspx.cs" Inherits="YourJester.ScreenMainFlow.PageStep01Results" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textError%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
