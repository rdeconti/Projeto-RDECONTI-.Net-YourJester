...
/// Goal:           Allow to user send e-mail to YourJester about any subject
/// *********************************************************************************************************************
...
{
    public partial class PageEmail : System.Web.UI.Page
    {
        ...
        /// Creation:	    2015, June
        /// Author:	    	Rosemeire Deconti
        /// Goal:           Send e-mail to YourJester
        /// *********************************************************************************************************************
        /// Maintenance:    yyyy/mm/dd
        /// Author:	    	Rosemeire Deconti
        /// Goal:           inform the description of maintenance
        ...
        protected void R0100SendEmail(object sender, EventArgs e)
        {
            emailSubject = txtEmailTitle.Text.ToString();
            emailFrom = txtEmailFrom.Text.ToString();
            emailTo = txtEmailTo.Text.ToString();
            emailBody = txtEmailMessage.Text.ToString();

            ///R0160TreatSendEmail object01 = new R0160TreatSendEmail();
            ///bool w_send_email = object01.Routine0160TreatSendEmail(emailSubject, emailTo, emailFrom,emailBody, "messageCode076");
            ///if (!w_send_email) return;
        }
