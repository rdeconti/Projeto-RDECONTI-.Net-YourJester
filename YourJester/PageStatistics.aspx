<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageStatistics.aspx.cs" Inherits="YourJester.PageStatistics" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textStatistics%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
