<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageCalendar.aspx.cs" Inherits="YourJester.PagePerpetualCalendar" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textCalendar%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
