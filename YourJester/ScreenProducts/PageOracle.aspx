<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageOracle.aspx.cs" Inherits="YourJester.PageOracle" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textOracle%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
