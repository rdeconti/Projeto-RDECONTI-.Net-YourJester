<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PageMandalas.aspx.cs" Inherits="YourJester.PageMandalas" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, textMandalas%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
