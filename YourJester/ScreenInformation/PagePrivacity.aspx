<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PagePrivacity.aspx.cs" Inherits="YourJester.ScreenInformation.PagePrivacy" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <h1 dir="auto" style="text-align: center">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, PagePrivacityPoliticTitle%>" />
                    </h1>
                </div>
                <div class="col-sm-4">
                    <h1 dir="rtl">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <p style="color: #FFFFFF; text-align: justify">
                        <asp:Literal runat="server" Text="<%$ Resources:Resources, PagePrivacityPoliticLongText%>" />
                    </p>
                    <p>
